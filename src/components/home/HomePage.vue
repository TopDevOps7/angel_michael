  ...
  <div class="home-bg">
    ...
    <div class="" style="padding: 80px; padding-top: 0px">
      <div class="row" style="padding-top: 30px">
        ...
        <div class="col-md-4">
          <button class="btn btn-primary btn-sm btn-lg" v-on:click="openModal">
            Add Task
          </button>
          <button
            class="btn btn-danger btn-sm btn-lg"
            id="delBtnId"
    ...
    <div id="myModal" class="c-modal" v-bind:class="{ openModal: isOpenModal }">
      ...
      <div class="c-modal-content">
        <div class="c-modal-header pt-4">
          <span id="crossBtnId" class="c-close" v-on:click="closeModal"
            >&times;</span
          >
          ...
          <div class="p-5">
            ...
            <div class="form-group">
              ...
              <input
                ...
                name="tags"
                class="form-control"
                :class="{ 'is-invalid': submitted && errors.has('tags') }"
              />
            </div>
            <div class="form-group">
              <button
...
<script
  ...
  src="../../../public/bootstrap-tagsinput.js"
></script>
<script>
        ...
        if (self.options.addOnBlur && self.options.freeInput) {
          self.$input.on(
            ...
            $.proxy(function (event) {
              ...
              if (
                $(".typeahead, .twitter-typeahead", self.$container).length ===
                0
              ) {
            ...
            if (event.which == 13) {
              ...
              if ($input.val() != "") {
                if (
                  ...
                  tagscus =
                    localStorage.getItem("TASK_TAGS") + ", " + $input.val();
                } else {
    ...
    addTask(e) {
      ...
      const requestOptions = {
        ...
        body: JSON.stringify({
          ...
          tag: this.task.tag,
          owner: localStorage.getItem("ATHENTICATE_USER"),
        }),
      };
      this.submitted = true;
      axios
        .post("/api/task/addTask", requestOptions)
